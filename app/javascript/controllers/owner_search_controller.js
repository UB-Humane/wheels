...
export default class extends Controller {
  ...
  search() {
    ...
    this._debounce = setTimeout(() => {
      ...
      fetch(`/productions/${this.productionIdValue}/members?q=${encodeURIComponent(q)}`)
        .then(r => r.json())
        .then(users => {
          this.dropdownTarget.innerHTML = ""
          if (!users.length) { this.dropdownTarget.hidden = true; return }
          users.forEach(u => {
            ...
            li.addEventListener("click",      () => this._select(u))
